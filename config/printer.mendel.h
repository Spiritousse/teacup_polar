...
#define KINEMATICS_CYLINDRICAL

#ifdef KINEMATICS_CYLINDRICAL
/** \def CYLINDRICAL dimensions
	Dimensions specifications of cylindrical 3D printer
	Needed to calculate the cartesian coordinates after
	homing
	
*/
//in cm
#define HOMING_RADIUS					50
//in degrees
#define HOMING_ANGLE					0							
#define GEAR_RATIO 1
#endif
...
#define STEPS_PER_M_X            		 10300 * MICROSTEPPING 
#ifdef KINEMATICS_CYLINDRICAL
#define STEPS_PER_ROTATION_Y			 200 * MICROSTEPPING 
#else
...
/** \def X_MIN X_MAX Y_MIN Y_MAX Z_MIN Z_MAX
  Soft axis limits. Define them to Y-plane machine's size relative to what your
...
*/
#define X_MIN                      HOMING_RADIUS
//#define X_MAX                    200.0

#define Y_MIN                      HOMING_ANGLE
//#define Y_MAX                    200.0
